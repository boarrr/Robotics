...
task main()
{
	// 50cm divided by wheel circumfrance to find rotations needed
	float rotationsNeeded = 360 * (50 / 17.6);
	...
	setMotorTarget(leftMotor, -730, 50);
	setMotorTarget(rightMotor, 730, 50);
